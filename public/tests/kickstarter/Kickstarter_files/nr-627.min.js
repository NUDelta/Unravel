! function(e, n, t) {
    ...
    4: [function(e, n) {
        ...
        function r(e) {
            return null === e || void 0 === e ? "null" : encodeURIComponent(e)
                .replace(l, t)
        }

        function o(e, n) {
            for (var t = 0, r = 0; r < e.length; r++)
                if (t += e[r].length, t > n) return e.slice(0, r)
                    .join("");
            return e.join("")
        }
        ...
        function o() {
            for (var e = document.cookie.split(" "), n = 0; n < e.length; n++)
                if (0 === e[n].indexOf("NREUM=")) {
                    for (var t, r, o, u, s = e[n].substring("NREUM=".length)
                            .split("&"), f = 0; f < s.length; f++) 0 === s[f].indexOf("s=") ? o = s[f].substring(2) : 0 === s[f].indexOf("h=") ? (o = s[f].substring(2), a.store("measures", "ph", {
                        value: 1
    ...
    21: [function(e, n) {
        ...
        function a(e, n) {
            ...
            } else e && "string" == typeof e.tagName && (t = e.tagName.toLowerCase(), e.id && (t += "#" + e.id), e.className && (t += "." + T(e.classList)
                .join(".")));
    ...
    23: [function(e, n) {
        n.exports = function(e) {
            ...
            return !r.port && o[1] && (r.port = o[1].split("/")[0].split("@")
                .pop()
                .split(":")[1]), r.port && "0" !== r.port || (r.port = "https" === o[0] ? "443" : "80"), r.hostname = n.hostname || t.hostname, r.pathname = n.pathname, r.protocol = o[0], "/" !== r.pathname.charAt(0) && (r.pathname = "/" + r.pathname), r.sameOrigin = !n.hostname || n.hostname === document.domain && n.port === t.port && n.protocol === t.protocol, r
        }
    }, {}],
    24: [function(e, n) {
        function t(e) {
