  ...
  function a() {
    ...
    if (j) {
      j.addEventListener("click", function (m) {
        var l = this;
        var n = {id: l.getAttribute("data-post-id"), key: l.getAttribute("data-reblog-key")};
...
(function (e, d, h, b) {
  var a = function () {
    ...
    var k = {transition: "transitionend", MozTransition: "transitionend", WebkitTransition: "webkitTransitionEnd"};
    for (i in k) {
  ...
  if (Tumblr.Flags.bool("allow_edit_appearance_in_popover")) {
    d.assign(f, {"click .tumblelog_popover .navigation button.customize_button": "__customize_button_click",})
  }
  var c = h.View.extend({
    el: "body",
    defaults: {
    ...
    initialize: function (i) {
      ...
      this.listenTo(Tumblr.Events, {"drawer:open": this.__drawer_opened, "drawer:close": this.__drawer_closed})
    },
    ...
    open_page: function (j, i) {
      ...
      if (this.is_open) {
        this.post_message("peepr_navigate", {url: j});
        return
      }
      ...
      this.setLoadTimeout();
      this.$iframe_wrapper = e("<div>", {"class": "ui_peepr_wrapper"}).appendTo(this.$body);
      this.$glass = e("<div>", {"class": "ui_peepr_glass"}).appendTo(this.$body);
      if (i) {
      ...
      Tumblr.Events.trigger("peepr:open", {
        ...
        loggingData: {tumblelog_name: this.current_tumblelog, post_id: this.current_post_id}
      });
    ...
    remove_unfollowed_posts: function (i) {
      Tumblr.Posts.whereBy({tumblelog: i.get("name"), sponsored: false}).invoke("dismiss")
    },
    ask: function (i) {
    ...
    update_tumblelog_model: function (k) {
      ...
      var m = new Tumblr.Prima.Models.Tumblelog({name: k.name});
      if (d.has(k, "following") && k.following !== m.get("following")) {
        var j = {source: (k.following) ? "FOLLOW_SOURCE_PEEPR_HEADER" : "UNFOLLOW_SOURCE_PEEPR_HEADER"};
        if (this.context) {
        ...
        m.save_following({following: k.following}, j);
    ...
    open_abuse_form: function (j) {
      ...
      d.delay(d.bind(function () {
        Tumblr.Events.trigger("abuseform:open", {post: i})
      }, this), 300);
      this.close()
    },
    show: function () {
  ...
  var d = e.View.extend({
    ...
    position: function () {
      ...
      if (this.is_poptica) {
        ...
        this.$popover.css({left: n, top: i})
      } else {
        this.$popover.addClass("up nipple_on_bottom");
        this.$popover.css({left: n, top: h})
      }
  ...
  var d = e.View.extend({
    ...
    on_ignore_click: function (f) {
      ...
      this.open_dialog(g, b.bind(function () {
        a.ignore({tumblelog: this.model.get("name")}, {
  ...
  var a = Tumblr.Popover.extend({
    ...
    __ignore_click: function (g) {
      ...
      this._open_dialog(h, c.bind(function () {
        Tumblr.ignore({tumblelog: this.model.get("name")}, {
    ...
    __flag_click: function (g) {
      g.preventDefault();
      Tumblr.Events.trigger("abuseform:open", {tumblelog: this.model.get("name"), targetPost: this.targetPost})
    },
    ...
    initialize: function (g) {
      ...
      this.isInPeepr = d(document.body).hasClass("indash_blog--peepr");
      this.listenTo(this.model, "change", this.__model_change);
...
(function (e, g, h, c) {
  ...
  var j = [{useraction: "follow", url: "/svc/follow"}, {
    ...
    useraction: "ignore",
    url: "/svc/ignore/add"
  }, {useraction: "unignore", url: "/svc/ignore/remove"}, {
    useraction: "reply",
    url: "/svc/reply"
...
(function (c, d, b, a) {
  a.NotesBaseView = d.View.extend({
    ignore: function (f) {
      ...
      g.done(function () {
        Tumblr.ignore({tumblelog: h, source: "IGNORE_SOURCE_NOTIFICATION"});
...
(function (c, d, b, a) {
  a.NoteView = Tumblr.NotesBaseView.extend({
    events: {"click a.block": "ignore"}, initialize: function () {
...
(function (c, d, b, a) {
  a.Notes = d.View.extend({
    ...
    el: "#posts",
    loading_notes: false,
    events: {"click .post_control.reblog_count": "toggle_notes", "click .more_notes_link_container": "more_notes"},
    create_note_views: function (e) {
      e.find(".note:not([data-view-exists])").each(function (g, h) {
        var f;
        if (c(h).hasClass("reblog")) {
          f = new Tumblr.ReblogNoteView({el: h})
        } else {
          f = new Tumblr.NoteView({el: h})
        }
    ...
    more_notes: function (i) {
      ...
      var g = f.find(".notes");
      h.hide();
      this.load_notes(f.attr("data-post-id"), f.attr("data-tumblelog-key"), {from_id: h.attr("data-next")}, b.bind(function (e) {
        j.remove();
  ...
  a.ReplyButtons = {
    init: function () {
      ...
      c("#posts").on("click", ".reply_button", function (f) {
        ...
        var g = f.currentTarget.id;
        if (!e[g]) {
          e[g] = new Tumblr.ReplyPopover({el: c(f.target)})
        }
        c(f.currentTarget).addClass("active");
        e[g].show()
      })
...
(function (e, g, b, a) {
  ...
  var f = g.View.extend({
    initialize: function () {
      ...
      e.ajax("/unpin", {
        type: "post",
        data: {post_id: this.$post.id().replace("post_", ""), form_key: e("#tumblr_form_key").attr("content")}
      })
    }
  });
  var d = {
...
(function (c, d, b, a) {
  a.PushButtons = d.View.extend({
    el: "#right_column", events: {"click li": "on_click"}, on_click: function (f) {
...
(function (c, d, b, a) {
  a.PostInlineImageToggle = d.View.extend({
    events: {"click .post_content img": "toggle"}, toggle: function (k) {
...
(function (d, c, e, b) {
  var a = e.Collection.extend({
    model: b.Post, initialize: function (g, f) {
      f = f || {}
    }
  });
  b.PostsCollection = a
...
(function (c, h, i, b) {
  ...
  b.Ads = h.View.extend({
    initialize: function () {
      ...
      var k = j.data("json");
      n.loggingData = i.extend(n.loggingData, {postData: k, userAction: l});
      this.preLogSetup(m);
      this.model.set({video_duration: m.duration, video_progress: m.position});
      if (l === "video_scrub_stop" || l === "video_restart") {
        this.model.set({video_scrub_start: m.start, video_scrub_end: m.end})
      }
      if (l === "video_resolution_change") {
        this.model.set({video_resolution: m.resolution})
      }
      this.doLog()
...
(function (e, d, k, l) {
  ...
  function g(n) {
    if (!window.next_page) {
      if (e("#auto_pagination_loader").is(":visible")) {
        e("#auto_pagination_loader").hide()
      }
      i.stop();
      return
    }
    ...
    if ((n.documentHeight - n.windowScrollY) < n.windowHeight * 3) {
      ...
      e("#auto_pagination_loader_loading").show();
      e("#auto_pagination_loader_failure").hide();
      f()
    }
  }
  ...
  function a() {
    j--;
    var n = e.ajax({url: window.next_page, type: "get"});
    n.done(function (p) {
      b(p);
      ...
      e("#auto_pagination_loader_loading").hide()
    });
    n.fail(function () {
      if (j) {
        a()
  ...
  function h() {
    i.stop();
    e("#auto_pagination_loader_loading").hide();
    e("#auto_pagination_loader_failure").show()
  }
...
(function (c, a) {
  var b = Backbone.Model.extend({
    ...
    poll: function () {
      ...
      var f = c.ajax({url: "/services/poll", type: "GET", data: g});
...
(function (a) {
  Tumblr.LinkButton = Backbone.View.extend({
    events: {click: "follow_link"}, initialize: function (b) {
...
(function (b) {
  var a = Backbone.Model.extend({
    initialize: function (c) {
      ...
      f = _.extend(f, {form_key: this.get("form_key")});
      var e = b.ajax({data: JSON.stringify(f), type: "POST", url: c});
      ...
      _.delay(function () {
        if (typeof Tumblr.Toaster === "object" && typeof Tumblr.ToastKit === "object") {
          var d = Tumblr.ToastKit.notification_center_convert(c.message, {
            ...
            tumblelog: {name: c.post_tumblelog.name_or_id, url: c.post_tumblelog.url, avatar: c.post_tumblelog.avatar}
          });
      ...
      var c = {post_id: this.get("id"), channel_id: this.get("tumblelog")};
      ...
      if (_.isObject(Tumblr.FanMail)) {
        var c = {href: Tumblr.FanMail.make_url_from_tumblelog(this.get("tumblelog"))};
        Tumblr.FanMail.show(c)
      }
    }, publish: function () {
      var c = b.ajax({url: "/publish", type: "post", data: {form_key: this.get("form_key"), id: this.get("id")}});
      ...
      Tumblr.follow({
        ...
        success: b.proxy(function () {
          Tumblr.Events.trigger("follow_tumblelog", {tumblelog: d});
      ...
      var e = Tumblr.ignore({tumblelog: f, source: this.getLikeSource("ignore")});
      var d = f.match(/post\_id\:/);
      var c = !d;
      e.done(_.bind(function () {
        Tumblr.Events.trigger("block_tumblelog", {tumblelog: f, can_report: c});
      ...
      var c = b.ajax({
        url: "/publish",
        type: "post",
        data: {form_key: this.get("form_key"), id: this.get("id"), queue: "queue"}
      });
      ...
      var c = b.ajax({
        ...
        type: "post",
        dataType: "text",
        data: {post_id: this.get("id"), tumblelog_id: this.get("tumblelog"), form_key: this.get("form_key")}
      });
      ...
      var e = {form_key: this.get("form_key"), id: this.get("id")};
      if (c) {
        e.queue = true
      }
      var d = b.ajax({url: "/approve_submission/" + this.get("id"), type: "post", dataType: "text", data: e});
      ...
      var c = b.ajax({
        ...
        type: "post",
        dataType: "text",
        data: {pid: this.get("id"), form_key: this.get("form_key")}
      });
...
(function (d) {
  ...
  Tumblr.PostView = Backbone.View.extend({
    events: {
      ...
      i.save_following({following: true}, {source: g, pt: this.model.get("pt")}).fail(function () {
        Tumblr.Dialog.alert(b.ajax_error)
      });
      ...
      if (!f) {
        f = {tumblelog: this.model.get("tumblelog"), sponsored: false}
      }
      ...
      if (c.bool("prima_post_forms")) {
        ...
        if (!this.richTextEditor) {
          var p = new Backbone.Model({editorType: "rich", answer: ""});
          ...
          q.after(this.richTextEditor.render().$el).hide()
        }
        d(this.richTextEditor.editor.element).focus(f).blur(h);
        ...
        if (j) {
          if (j.get(o)) {
            ...
            i.on("change:upload_complete", function (t) {
              ...
              var r = new Image();
              d(r).one("load", _.bind(function (v) {
                d(r).off();
      ...
      d.ajax({
        method: "POST",
        url: "/svc/search/log_dismissal",
        data: {tumblelog_name: this.model.get("tumblelog")},
        with_form_key: true
      })
    }, edit: function (g) {
      var f = {
      ...
      if (c.bool("prima_post_forms")) {
        g.preventDefault();
        a.trigger("postForms:edit", {postEl: f.attach_to, editId: f.post_id, channelId: f.channel_id})
      } else {
        if (Tumblr.PostForms) {
      ...
      if (!(this.adminPopover instanceof Tumblr.AdminPopover)) {
        this.adminPopover = new Tumblr.AdminPopover({model: this.model, el: d(f.target)})
      }
      ...
      if (!(this.replyPopover instanceof Tumblr.ReplyPopover)) {
        this.replyPopover = new Tumblr.ReplyPopover({model: this.model, el: g, glassless: true});
      ...
      if (typeof Tumblr.Toaster === "object" && typeof Tumblr.ToastKit === "object") {
        var f = Tumblr.ToastKit.notification_center_convert(g.message, {
          ...
          tumblelog: {name: g.post_tumblelog.name_or_id, url: g.post_tumblelog.url, avatar: g.post_tumblelog.avatar}
        });
      ...
      Tumblr.follow({tumblelog: i, source: "FOLLOW_SOURCE_NOTES_POPOVER"}, {
        success: function () {
          Tumblr.Events.trigger("follow_tumblelog", {tumblelog: i})
        }
      })
      ...
      var m = {tumblelog: this.model.get("tumblelog"), post_id: this.model.get("id")};
      ...
      var n = Tumblr.TumblelogActions.confirm_ignore({confirm_text: l, tumblelog: m.tumblelog, avatar_url: g});
      n.done(_.bind(function () {
        Tumblr.ignore(m, {
          success: _.bind(function () {
            this.model.set("ignoring", true);
            this._hide_posts({id: this.model.get("id"), sponsored: false})
          }, this)
        })
      }, this))
    }, hidePost: function () {
      ...
      if (f.width() < g.width()) {
        ...
        h = new Tumblr.DraggableTags({el: f})
      }
    }, checkForVendor: function () {
      var g = this.$(".vendor_button");
      if (g.length) {
        var f = new Tumblr.VendorButton({el: g, vendorData: g.data("vendor-json"), postModel: this.model})
      }
      ...
      setTimeout(_.bind(function () {
        ...
        if (f) {
          this.dockable_video_embed = new Tumblr.PostView.DockableVideo({model: this.model, el: f})
        }
      }, this))
      ...
      Tumblr.Events.trigger("explore-trending:badge-click", {loggingData: {post_id: this.model.id}})
      ...
      Tumblr.Events.trigger("useraction:click:install_click", {
        model: this.model,
        loggingData: this.loggingData({userAction: "install_click", url: (f.attr("href") || "")})
      })
...
(function (b) {
  var a = Backbone.View.extend({
        ...
        if (d.animation === "fall") {
          ...
          if (d.animation === "slide") {
            ...
            this.listenToOnce(this.dockablePost, "afterRender", function () {
              this.$el.velocity({bottom: e, opacity: 1,}, {
    ...
    removeFromGutter: function () {
      var c = this.$placeholder.get(0).getBoundingClientRect();
    ...
    returnToOriginalState: function (c) {
      ...
      this.fixElInOriginalPlace({
        animate: (c), complete: _.bind(function () {
    ...
    slideOutOfGutter: function () {
      ...
      this.$el.velocity({translateY: c, opacity: 0}, {
        duration: 400, easing: "ease", complete: _.bind(function () {
    ...
    buildPlaceholder: function (c) {
      ...
      this.$dockable_video_placeholder.css({width: c.width, height: c.height});
...
(function (f, a) {
  ...
  var e = Backbone.View.extend({
    tagName: "ul", events: {"click .show_more": "show_more"}, initialize: function (g) {
      ...
      this.before_render();
      this.$el.html(_.template(this.template, {heading: this.data.heading || "", context: this.data.context || ""}));
      ...
      var g = _.template(f("#follow_list_" + this.data.context + "_small_links_template").html(), {user_is_editor: this.data.user_is_editor || false});
      this.$el.append(g)
...
jQuery(document).ready(function (b) {
  if (!Tumblr.Flags.bool("prima_recommended_blogs_list") || b("#tagged_actions_display").hasClass("is_featured_tag")) {
...
(function (d, a) {
  ...
  var e = {
    initialize: function () {
      ...
      this.view = new b({model: this.model, recipient: h, allow_anonymous: i}).show_form()
    }
  };
  var f = Backbone.Model.extend({
    defaults: {form_key: d("#tumblr_form_key").attr("content")},
    urlRoot: "/svc/post/ask",
    validate: function (g) {
      if (!d.trim(g.question)) {
        return {error: c("You need to enter a question!")}
      } else {
        if (this.is_url(g.question)) {
          return {error: c("Sorry, but please don't include links in questions.")}
        }
      }
  ...
  var b = Backbone.View.extend({
    ...
    initialize: function (g) {
      ...
      this.keyboard_events = {keydown: _.bind(this.__keydown, this)};
      this.spinner = new Spinner(h)
    },
    render: function () {
      var g = _.template(this.template);
      this.$body.append(this.$el.append(g({recipient: this.recipient, allow_anonymous: this.allow_anonymous})));
      this.cache_selectors();
      this.is_ie9 = d("html").hasClass("ie9");
      if (this.is_ie9) {
        this.disable_submit()
      }
      Tumblr.PlaceHolders.init({els: this.$("#question"), clear_on_submit: true});
      return this
    },
    cache_selectors: function () {
      this.$form = this.$("form");
    ...
    update: function () {
      ...
      if (g <= 100) {
        ...
        if (g > 40) {
          this.$character_count.css({color: "#a8b1ba"})
        } else {
          if (g > 20 && g <= 40) {
            this.$character_count.css({color: "#b2212e"})
          } else {
            this.$character_count.css({color: "#cd1828"})
          }
        }
      } else {
    ...
    submit_form: function () {
      ...
      this.model.save(g, {
        ...
        }, this), error: _.bind(function (h, i) {
          clearTimeout(this.delay_loader);
          this.hide_loader();
    ...
    initialize: function () {
      ...
      if (this.version === "v2" && this.$el.hasClass("radar_type_video")) {
        ...
        if (this.version === "v2" && this.$el.find(".photoset").length > 0) {
          ...
          this.slideshow = new Tumblr.RadarPhotosetSlideshow({container: g, image_urls: m})
        }
      }
      var l = new Tumblr.Notes({el: this.el})
    },
  ...
  a.ImpressionTracking = {
    initialize: function () {
      ...
      _.each(c(d + ":not(.mb_tracked)"), function (f) {
        ...
        this.tracking.push({was_below: null, el: f, $el: e})
      }, this)
    }, track: function () {
      ...
      try {
        c.ajax({
          url: "/svc/log/yx",
          type: "POST",
          data: {type: h, post_id: d.data("postId"), placement_id: j, pt: JSON.stringify(f)},
          with_form_key: true
        })
      } catch (e) {
      }
