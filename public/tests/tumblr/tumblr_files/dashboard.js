...
(function(a) {
    ...
    d.prototype = {
        ...
        css_text: function() {
            var f = this.selectors_to_text(this.selectors, this.selectors_order)
                .replace(/</g, "&lt;")
                .replace(/>/g, "&gt;");
            var g = this.animations_to_text(this.animations)
                .replace(/</g, "&lt;")
                .replace(/>/g, "&gt;");
            return f + g
        },
...
Tumblr.FollowTeaser = (function() {
    ...
    return {
        ...
        initialize: function(t) {
            ...
            e = Math.min(e, 3 * Tumblr.windowDimensions()
                .height);
            var r = this;
...
Tumblr.Lightbox = (function() {
    ...
    function m() {
        ...
        document.getElementById("tumblr_lightbox")
            .style.display = "none";
    ...
    function l(r) {
        ...
        document.getElementById("tumblr_lightbox_left_link")
            .onclick = function() {
                j = true;
                l(r - 1);
                return false
        ...
        if (d.length == 1) {
            document.getElementById("tumblr_lightbox_center_link")
                .onclick = function() {
                    return false
                }
        } else {
        ...
        document.getElementById("tumblr_lightbox_right_link")
            .onclick = document.getElementById("tumblr_lightbox_center_link")
            .onclick;
        c.left = false;
        c.center = false;
        c.right = false;
    ...
    function k() {
        ...
        while (stage_name = v.pop()) {
            ...
            if (e()
                ...
                if (e()
                    .width * u > r && (t.className == "high-res" || t.style.maxWidth)) {
                    s.style.width = r + "px";
                    s.style.height = q + "px"
                } else {
                    s.style.height = (q * ((e()
                ...
                if (e()
                    .height * 0.85 > q && (t.className == "high-res" || t.style.maxHeight)) {
                    s.style.width = r + "px";
                    s.style.height = q + "px"
                } else {
                    s.style.width = (r * ((e()
            ...
            if (stage_name == "center") {
                ...
                if (stage_name == "right") {
                    ...
                    s.style.left = (0 - parseInt(s.style.width, 10) - e()
                        .width * 0.42) + "px";
                    s.style.top = (0 - parseInt(s.style.height, 10) / 2) + "px"
                }
            }
            ...
            if (stage_name == "center" && d[h - 1].caption) {
                document.getElementById("tumblr_lightbox_caption")
                    .innerHTML = d[h - 1].caption;
                document.getElementById("tumblr_lightbox_caption")
                    .style.width = (e()
                        .width * 0.7) + "px";
                document.getElementById("tumblr_lightbox_caption")
                    .style.top = (parseInt(s.style.height, 10) * 0.5) + "px";
                document.getElementById("tumblr_lightbox_caption")
                    .style.left = (0 - e()
                        .width * 0.35) + "px";
                document.getElementById("tumblr_lightbox_caption")
    ...
    return {
        post_message_event: function(c, b) {
            if (c[0] === "resize_photoset_iframe") {
                var d = c[1],
                    a = parseInt(c[2], 10);
                document.getElementById("photoset_iframe_" + d)
                    .height = a
            }
        }
    }
            ...
            if (c) {
                ...
                if (h && e) {
                    ...
                    if (j[0] === "location_change") {
                        ...
                        document.getElementById("tumblr_controls")
                            .onload = function() {
...
Tumblr.VideoFeatureSupport = (function() {
    ...
    function h() {
        if (typeof(get_cookie) === "function") {
            var j = get_cookie("supress_lightbox"),
                k = parseInt(j.value, 10) || 0;
            if (j && k > 3) {
...
(function(b) {
    var a = {
        get: function(c) {
            return new RegExp(c + "=([^;]+)")
                .test(unescape(document.cookie)) ? RegExp.$1 : null
        },
    ...
    a.PopoverWithScroll = Tumblr.Popover.extend({
        ...
        get_container_width: function() {
            if (this.containing_frame === window) {
                return Tumblr.Prima.DOMEventor.rect()
                    .windowWidth
            } else {
                return c(this.containing_frame)
                    .outerWidth(true)
            }
        },
        show: function() {
            ...
            if (this.auto_center) {
                ...
                if (this.popover) {
                    ...
                    if ((e - this.$el.offset()
                            .left - this.$el.outerWidth(true)) < this.popover.outerWidth(true)) {
                        this.popover.addClass("nipple_on_right")
                            .removeClass("nipple_on_left")
                    } else {
                        this.popover.addClass("nipple_on_left")
                            .removeClass("nipple_on_right")
                    }
                }
            }
        ...
        position_vertical: function() {
            ...
            var f = 50 - (this.$container.outerHeight(true) * 0.5),
                g = c(window)
                .height(),
                j, h, e;
    ...
    e.prototype = {
        ...
        _init: function() {
            ...
            if (this.opts.color !== "auto") {
                c(".Knight-Rider-bar", this.$loader)
                    .css("background-color", this.opts.color)
            }
...
(function(e, d, h, b) {
    ...
    var c = h.View.extend({
        ...
        initialize: function(i) {
            ...
            this.transition_end = (this.options.transition_hook) ? a() : false;
            this.loader = null;
            ...
            this.listenTo(Tumblr.Events, {
                "drawer:open": this.__drawer_opened,
                "drawer:close": this.__drawer_closed
            })
        },
        ...
        __drawer_opened: function() {
            this.__drawer_is_open = true
        },
        __drawer_closed: function() {
            this.__drawer_is_open = false
        },
        ...
        __link_click: function(k) {
            ...
            var j = i.attr("href") || "";
            this.context.path = e(k.target)
                .closest("[data-context-path]")
                .data("context-path");
            if (!j && i.closest(".ui_avatar_link")
                .length > 0) {
                j = i.closest(".ui_avatar_link")
                    .attr("href")
            }
        ...
        __message: function(l) {
            ...
            switch (m) {
                ...
                case "peepr_update_tumblelog_model":
                    ...
                    break;
                case "peepr_open_abuse_form":
                    this.open_abuse_form(j);
                    break
            }
        },
        ...
        opening_error: function() {
            ...
            this.$error = e(this.error_template())
        ...
        open_page: function(j, i) {
            ...
            this.$glass = e("<div>", {
                ...
                .appendTo(this.$body);
            if (i) {
                this.$arrows = e(this.arrows_template())
                    .appendTo(this.$body);
            ...
            Tumblr.Events.trigger("toaster:suspend")
        },
        intro: function() {
            if (this.options.transition_hook && this.transition_end) {
        ...
        ask: function(i) {
            new Tumblr.DashboardAskView({
                    ...
                    allow_anonymous: i.anonymous_asks || false
                })
                .show_form();
        ...
        open_abuse_form: function(j) {
            var i;
            j.post["tumblelog-data"] = j.post.tumblelog_name;
            if (Tumblr.Flags.bool("prima_post_model")) {
                i = new Tumblr.Prima.Models.Post(j.post)
            } else {
                i = new Tumblr.Post(j.post)
            }
            d.delay(d.bind(function() {
                Tumblr.Events.trigger("abuseform:open", {
                    post: i
                })
            }, this), 300);
            this.close()
        ...
        destroy: function() {
            ...
            if (d.isObject(Tumblr.KeyCommands) && !this.__drawer_is_open) {
                Tumblr.KeyCommands.resume()
            }
        },
        ...
        arrows_template: d.template(e("#peepr_arrows")
            .html()),
        error_template: d.template(e("#peepr_error")
            .html())
    });
    var g = {
        init: function() {
        ...
        open_abuse_form: function(i) {
            i = JSON.stringify(i);
            parent.postMessage("peepr_open_abuse_form:" + i, "*")
        }
    };
...
(function(c, d, b, a) {
    a.LegalPopover = d.View.extend({
        initialize: function() {
            ...
            this.popover = new Tumblr.Popover({
                ...
                on_show: b.bind(function() {
                    this.$el.addClass("show");
                    this.$el.closest("#sidebar_footer_nav")
                        .addClass("show_popover");
                    this.close_on_scroll()
                }, this),
                on_hide: b.bind(function() {
                    this.$el.removeClass("show");
                    this.$el.closest("#sidebar_footer_nav")
                        .removeClass("show_popover")
                }, this)
            });
        ...
        close_on_scroll: function() {
            c(window)
                .on("scroll.legalpopover", b.bind(function() {
                    this.popover.hide();
                    c(window)
                        .off("scroll.legalpopover")
                }, this))
        }
    })
})(jQuery, Backbone, _, Tumblr);
...
(function(c, d, b, a) {
    a.BaseSearchPopover = d.View.extend({
        ...
        initialize: function(e) {
            ...
            Tumblr.Events.on("DOMEventor:flatresize", b.debounce(this.resize_view, 300)
                .bind(this));
            Tumblr.Events.on("SearchPopover:update", b.debounce(this.on_update, 300)
                .bind(this))
        },
        ...
        resize_view: function() {
            var e = {},
                f = this.popover.popover;
            if ((this.cached_popover_height > this.winRect.windowHeight)) {
                if ((f.height() + f.position()
                        .top) > this.winRect.windowHeight - 200) {
                    e = {
        ...
        bind_key_nav: function() {
            c(document)
                .off("keydown", this.keyevents.bind_key_down);
            c(document)
                .off("keyup", this.keyevents.bind_key_up);
            c(document)
                .on("keydown", this.keyevents.bind_key_down);
            c(document)
                .on("keyup", this.keyevents.bind_key_up)
        },
...
(function(c, d, b, a) {
    a.ReplyPopover = Tumblr.PopoverWithForm.extend({
        ...
        initialize: function(e) {
            this.options = e || {};
            var f = b.template(c(this.template)
                .html());
            this.$el.html(f());
    ...
    a.ReplyButtons = {
        init: function() {
            var e = {};
            c("#posts")
                .on("click", ".reply_button", function(f) {
...
(function(c, b, e, a) {
    var d = a.Popover.extend({
        ...
        _position_popover: function() {
            this.popover.css({
                right: "auto",
                left: (this.$button.length) ? this.$button.offset()
                    .left : ""
            });
            this.position()
        },
        ...
        cache_selectors: function() {
            ...
            if (c(".share_twitter")
                .length) {
                this.twitter_username = c(".share_twitter")
...
(function(d, e, b, a) {
    var c = a.SharePopoverBase.extend({
        _fadeout_popover: function() {
            ...
            setTimeout(b.bind(function() {
                this.popover.removeClass("flyaway")
                    .hide();
                this.reset_and_hide()
            }, this), 1000)
        },
        cache_selectors: function() {
            ...
            if (d(".share_twitter")
                .length) {
                this.$twitter_username = d(".share_twitter")
                    .data("twitter-username")
            }
            if (d(".share_facebook")
                .length) {
                this.$share_to_facebook = d(".share_facebook")
                    .data("has-facebook")
            }
    ...
    a.ShareButtons = {
        init: function() {
            var f = {};
            d("#posts")
                .on("click", ".share_social_button", function(i) {
...
(function(c, b, a) {
    var d = {
        ...
        hex_brightness: function(i, q) {
            ...
            return "#" + (16777216 + n * 65536 + k * 256 + h)
                .toString(16)
                .slice(1)
        },
...
(function(d, b, e, a) {
    var c = e.View.extend({
        ...
        initialize: function(f) {
            ...
            this.checkbox_template = b.template(d("#tumblelog_header_checkbox_template")
                .html());
            this.color_picker_template = b.template(d("#tumblelog_header_color_picker_template")
                .html());
            this.is_showing = false;
            this.$popover = null;
...
(function(d, b, e, a) {
    var c = a.Popover.extend({
        template: b.template(d("#tumblelog_header_info_popover_template")
            .html()),
        defaults: {
        ...
        __model_change: function() {
            ...
            this.$(".toggle_spam")
                .toggleClass("is_flagged", !!(f.spam));
            this.$(".toggle_nsfw")
                .toggleClass("is_flagged", !!(f.nsfw));
            this.$(".toggle_suspended")
                .toggleClass("is_flagged", !!(f.suspended))
        },
        initialize: function(f) {
            ...
            this.$popover = d(this.template(g))
                .appendTo(this.$el)
                .hide();
...
(function(c, b, e, a) {
    var d = e.View.extend({
        ...
        _render_inline_styles: function() {
            ...
            if (!g) {
                this.$(".navigation .nav_icon")
                    .css("color", f);
                this.$(".navigation .blog_name")
                    .css("color", f);
                this.$(".navigation .post_dismiss")
                    .css("color", f);
                this.$(".navigation .dismiss_icon")
                    .css("color", f);
        ...
        initialize: function(f) {
            ...
            this.template = b.template(c("#tumblelog_header_template")
                .html());
        ...
        render: function() {
            ...
            this.$el.html(this.template(b.merge(g, {
                ...
                title_color_rgb: String(b.values(f)
                    .join(","))
        ...
        strip_description_line_breaks: function() {
            this.$description_inner.find("br")
                .remove();
        ...
        truncate_description: function() {
            ...
            this.$description.append(this.description_gradient_template({
                background_color: String(b.values(g)
                    .join(","))
            }))
        },
...
(function(c, b, e, a) {
    var d = e.View.extend({
        ...
        initialize: function(g) {
            ...
            this.options = g || {};
            this.popover_template = c.trim(this.options.template || c("#tumblelog_popover_template")
                .html());
            ...
            if (this.is_mobile) {
                ...
                this.$el.hoverIntent({
                    selector: h.join(","),
                    over: b.bind(this.on_mouseover, this),
                    out: c.noop
                })
            }
        ...
        sync_storage: function() {
            ...
            c(window)
                .on("beforeunload", b.bind(function() {
        ...
        show: function() {
            var h, i = true,
                f = c(this.current_target),
                g = (a.Utils.popover.cache) ? a.Utils.popover.cache[this.current_tumblelog] : null;
            if (g && g.data) {
            ...
            if (this.is_poptica) {
                ...
                this.$popover.find(".popover_inner")
                    .prepend(this.subviews.poptica_header.render()
                        .el);
            ...
            if (this.context_path) {
                this.$popover.find("[data-context-path]")
                    .each(b.partial(function(j) {
                        var k = c(this);
            ...
            this.subviews.highlighted_posts = new a.TumblelogPopover.Posts({
                ...
                post: this.current_post,
                popover: this.$popover,
                parent: this.$popover.find(".popover_inner")
                    .first(),
        ...
        animate_in: function() {
            ...
            if (this.$popover) {
                this.$popover.removeClass("is_closed")
                    .addClass("is_open")
            }
        },
        animate_out: function() {
            ...
            if (this.$popover) {
                this.$popover.removeClass("is_open")
                    .addClass("is_closed")
            }
            try {
                this.stopListening(this.model)
        ...
        position: function() {
            ...
            n = (l.offset()
                .top > top) ? this.current_mouse_x : n;
            l.css("white-space", "");
            ...
            if (m > p.bottom - j) {
                ...
                this.$popover.removeClass("down nipple_on_top")
                    .addClass("up nipple_on_bottom");
            ...
            if (o.right > p.right - j) {
                ...
                this.$popover.removeClass("right")
                    .addClass("left");
                o = a.Utils.popover.get_bounds(this.$popover)
            }
        ...
        bind_events: function() {
            if (this.is_mobile) {
                c(document)
                    .on("touchstart.tumblelog_popover", b.bind(this.on_touch_close, this))
            } else {
                c(document)
                    .on("mousemove.tumblelog_popover", b.throttle(b.bind(this.on_mousemove, this), 50))
            }
        },
        unbind_events: function() {
            c(document)
                .off(".tumblelog_popover")
        },
        set_hide_posts_on_unfollow: function() {
            this.hide_posts_on_unfollow = true
        },
        on_mouseover: function(m) {
            var f, n, k, j, h = c(m.currentTarget),
                g = h.attr("href"),
                l = !!(h.attr("data-tumblelog-popover")),
                q = (h.text()
                    .replace(/\s+/g, " ")
                    .length > 1),
                p = h.hasClass("post_avatar_link");
            is_sub_avatar = h.hasClass("post_sub_avatar");
            this.current_mouse_x = m.clientX;
            var i = h.closest(".post")
                .data("post-id") || h.closest(".radar")
                .data("post-id") || "";
        ...
        on_mousemove: function(h) {
            ...
            var i = !(this.hover_bounds.left <= h.pageX && h.pageX <= this.hover_bounds.right),
                g = !(this.hover_bounds.top <= h.pageY && h.pageY <= this.hover_bounds.bottom);
            var f = c(h.target)
                .hasClass("icon_close");
            if (i || g || f) {
                this.animate_out()
...
(function(c, b, e, a) {
    var d = e.View.extend({
        ...
        initialize: function(f) {
            this.options = f || {};
            this.template = b.template(this.options.template || c("#tumblelog_popover_info")
                .html());
        ...
        close: function() {
            ...
            c(document)
                .off(".tumblelog_popover_menu");
            this.remove()
        },
        update_cache: function() {
            var f = this.model.toJSON(),
                g = this.model.get("name");
        ...
        on_menu_click: function(f) {
            ...
            if (!this.is_menu_open) {
                this.show_menu();
                c(document)
                    .on("mouseup.tumblelog_popover_menu", b.bind(this.on_menu_mouseup, this))
            }
        ...
        on_menu_mouseup: function(h) {
            ...
            var i = !(f.left <= h.pageX && h.pageX <= f.right),
                g = !(f.top <= h.pageY && h.pageY <= f.bottom);
            if (i || g) {
                c(document)
                    .off(".tumblelog_popover_menu");
                this.hide_menu()
...
(function(c, b, e, a) {
    var d = e.View.extend({
        ...
        initialize: function(f) {
            ...
            this.template = b.template(this.options.template || c("#recommended_blogs_template")
                .html());
            this.posts_template = b.template(this.options.posts_template || c("#highlighted_posts_template")
                .html());
        ...
        render: function() {
            ...
            this.$popover.find(".recommended_blogs")
                .html(this.template(g));
            var f = 1;
        ...
        _after_animation: function() {
            this.$popover.find(".popover_inner:not(.recommended_blogs)")
                .remove();
...
(function(d, c, f, b) {
    var a = Tumblr.Popover.extend({
        template: c.template(d("#tumblelog_header_info_popover_template")
            .html()),
        defaults: {
            auto_show: false,
            skip_glass: false,
        ...
        __ignore_click: function(g) {
            g.preventDefault();
            if (!Tumblr.TumblelogActions) {
                return
            }
            var h = Tumblr.TumblelogActions.confirm_ignore({
                tumblelog: this.model.get("name"),
                avatar_url: this.model.get("avatar_url") || ""
            });
            this._open_dialog(h, c.bind(function() {
                Tumblr.ignore({
                    tumblelog: this.model.get("name")
                }, {
        ...
        __model_change: function() {
            var g = this.model.toJSON();
            this.$(".toggle_spam")
                .toggleClass("is_flagged", !!(g.spam));
            this.$(".toggle_nsfw")
                .toggleClass("is_flagged", !!(g.nsfw))
        },
        __document_click: function(i) {
            ...
            var j = !(g.left <= i.pageX && i.pageX <= g.right),
                h = !(g.top <= i.pageY && i.pageY <= g.bottom);
            if (j || h) {
                this.hide()
            }
        },
        ...
        initialize: function(g) {
            ...
            this.$doc = d(document);
            this.$popover = d(this.template(h))
                .appendTo(this.$el)
                .hide();
            this.isInPeepr = d(document.body)
                .hasClass("indash_blog--peepr");
            this.listenTo(this.model, "change", this.__model_change);
...
(function(d, c, e, b) {
    var a = e.View.extend({
        ...
        initialize: function(f) {
            f || (f = {});
            this.template = c.template(d("#highlighted_posts_template")
                .html());
...
(function(d, e, b, c, a) {
    a.LanguageMenu = Tumblr.Popover.extend({
        ...
        select_language: function(f) {
            ...
            f.preventDefault();
            d("#language_selected")
                .val(g.attr("data-lang"));
            d("#language_switcher .current")
                .removeClass("current");
            if (this.spinner) {
                this.spinner.stop()
            } else {
        ...
        set_language: function() {
            var f = b(this.language_form.serializeArray())
                .map(function(g) {
...
(function(c, d, b, a) {
    a.ReportTumblelogView = d.View.extend({
        ...
        animate_in: function() {
            this.$el.find("#report_tumblelog_with_name")
                .show();
            this.$el.find("#report_tumblelog_name")
                .html(this.tumblelog);
            this.$el.fadeIn(300)
        },
    ...
    a.FullHeightNoPostsFound = d.View.extend({
        initialize: function() {
            ...
            if (this.$no_posts_found.length && this.$left_column.length && this.$right_column.length) {
                ...
                var f = this.$left_column.height(),
                    e = this.$right_column.height(),
                    h = 0,
                    g = "+";
                if (f < e) {
                    g = "+";
        ...
        center_padding: function(e, g) {
            if (e > 0 && (g === "+" || g === "-")) {
                var f = e / 2;
                this.$no_posts_found.css("padding-top", g + "=" + f)
                    .css("padding-bottom", g + "=" + f)
            }
        }
    })
})(jQuery, Backbone, _, Tumblr);
...
(function(c, d, b, a) {
    a.FanMail = {
        show: function(k, i) {
            ...
            j.load(function() {
                c("#send_fan_mail_lightbox_loader")
                    .hide();
...
(function(d, e, b, a) {
    ...
    a.TumblelogActions = {
        ...
        confirm_unfollow: function(g) {
            ...
            g.confirm_text = Tumblr.Dialog.__("Are you sure you want to unfollow %1$s?")
                .replace("%1$s", "<strong>" + g.tumblelog + "</strong>");
...
(function(d, e, b, a) {
    ...
    a.NotificationView = Tumblr.NotesBaseView.extend({
        ...
        update: function() {
            this.$el.find(".notification .notification_text")
                .each(function(g, h) {
                    var f = d(h);
                    if (f.find("a")
                        .length > 1) {
            ...
            this.$el.find(".notification a.block")
                .each(function(g, h) {
                    var f = d(h);
                    f.closest(".notification")
                        .addClass("can_ignore")
                })
        },
        ...
        notification_click: function(h) {
            ...
            if (!f.is("a") && !f.is(".photo_reply_image_container")) {
                h.stopPropagation();
                h.preventDefault();
                var g = this.$el.find(".notification_target")
                    .attr("href");
                if (!g && this.$el.find("a")
                    .length === 1) {
                    g = this.$el.find("a")
...
(function(c, d, b, a) {
    a.Notifications = d.View.extend({
        ...
        updateViews: function() {
            this.$el.find(".notification:not([data-view-exists])")
                .each(function(f, g) {
                    var e = c(g);
...
(function(c, d, b, a) {
    a.ReblogNoteView = Tumblr.NoteView.extend({
        ...
        note_click: function(i) {
            var g = c(i.target);
            var f = c(i.currentTarget);
            if (!g.is("a") && !g.is("img") && !g.closest(".follow")
                .length) {
                i.stopPropagation();
                i.preventDefault();
                var h = f.find(".action")
...
(function(c, d, b, a) {
    a.Notes = d.View.extend({
        ...
        create_note_views: function(e) {
            e.find(".note:not([data-view-exists])")
                .each(function(g, h) {
                    var f;
                    if (c(h)
                        .hasClass("reblog")) {
...
(function(e, g, b, a) {
    ...
    var f = g.View.extend({
        ...
        clicked: function() {
            if (this.$el.closest(".logged_out")
                .length || this.$el.data("reblogged")) {
                return
            }
            this.reblog();
            this.$el.addClass("animated")
                .addClass("collapse_reblog_button");
            window.setTimeout(b.bind(function() {
    ...
    var d = {
        init: function() {
            e("#posts")
                .on("click", ".reblog_button", function(h) {
    ...
    var a = function(g, f) {
        ...
        if (this.config.create_container) {
            this.$container = d("<div/>")
                .addClass(this.config.container_class)
                .insertBefore(this.$el);
            this.$container.append(this.$el);
            this.$clearfix = d("<div/>")
                .addClass(this.config.clearfix_class)
        ...
        this.$anchor = d("<span/>")
            ...
            .addClass(this.config.anchor_class)
            .insertAfter(this.$el);
...
(function(d, e, b, a) {
    ...
    c.prototype = {
        ...
        create_shadow: function(f) {
            this.$shadow = (d("." + this.config.shadowClass)
                .length) ? d("." + this.config.shadowClass) : d("<div/>", {
...
(function(c, e, b, a) {
    var d = function(g, f) {
        ...
        this.$relay_targets = c(this.$el.find(this.config.child_selector))
            .add(c(this.config.global_selector));
    ...
    d.prototype = {
        __relay: function(f) {
            if (this.__is_relay_element(f)) {
                f.stopPropagation();
                this.$relay_targets.not(f.target)
                    .trigger(f)
            }
        },
...
(function(c, d, b, a) {
    a.DraggableTags = d.View.extend({
        ...
        mousedown: function(f) {
            this.$dragging = this.$(f.currentTarget)
                .addClass("dragging");
            this.mouse_down_left = f.offsetX || f.clientX - this.$(f.currentTarget)
                .offset()
                .left;
            f.preventDefault();
            f.stopPropagation()
...
(function(c, d, b, a) {
    a.PostInlineImageToggle = d.View.extend({
        ...
        toggle: function(k) {
            var h = this.$(k.currentTarget)
                .parents(".post_content");
...
(function(c, d, b, a) {
    a.PostVideoEmbedToggle = d.View.extend({
        ...
        show_video: function(l) {
            ...
            var h = f.find(".video");
            var i = m.find(".video_preview")
                .data("permalink");
            var k = f.find(".video_embed_code")
                .val();
...
(function(d, e, b, a) {
    ...
    a.AnswerPost = e.View.extend({
        ...
        answer: function(f) {
            d("#answer_form_" + f + " [name=redirect_to]")
                .remove();
            var h = "#answer_container_" + f;
            var g = d(h)[0];
            var m = g.children[0].className;
            var l = d("#answer_text_" + f)[0];
            var k = g.querySelector(".answer_avatar")
                .outerHTML;
            var j = d("#answer_form_" + f)
                .serialize();
            if (!l.value) {
                return
            }
...
(function(c, d, b, a) {
    a.LoggingPostMessage = d.View.extend({
        ...
        getPostData: function(e) {
            return this.postData || (this.postData = c("#post_" + e)
                .data("json"))
        },
        _listen: function() {
            var e = this._listen_handler;
            c(window)
                .on("message.PmEvent", b.bind(e, this))
        },
    ...
    b.Ads = h.View.extend({
        ...
        prepVideoPlay: function(k) {
            ...
            if (j.state === "focus" || j.state === "playing") {
                ...
                var k = {
                    loggingData: {
                        postData: this.get$EmbedPost(j.embedID)
                            .data("json") || {},
                        userAction: "video"
                    }
                };
...
(function(d, e, g, c) {
    ...
    function b(l, m, o) {
        var j = (o == null) ? d("#like_form_" + l) : d("#" + o),
            k;
        if (!j.length) {
            return
        }
    ...
    function f(m) {
        ...
        var l = k.attr("action");
        d("#post_" + m)
            .addClass("force_redraw");
        d("#post_" + m)[0].offsetHeight;
        d("#post_" + m)
            .removeClass("force_redraw");
    ...
    function h(j) {
        ...
        d("#show_notes_link_" + j)
            .show();
        if (d("#note_link_less_" + j)
            .is(":visible")) {
            d("#note_link_less_" + j)
                .hide();
            d("#note_link_current_" + j)
                .show();
            d("#note_link_more_" + j)
                .hide()
        } else {
...
(function(e, d, k, l) {
    var i = {
        start: function() {
            j = 3;
            Tumblr.Events.on("DOMEventor:flatscroll", g)
        },
        stop: function() {
            window.loading_next_page = false;
            Tumblr.Events.off("DOMEventor:flatscroll", g)
        },
        flushQueue: function() {
            c()
        }
    ...
    function g(n) {
        if (!window.next_page) {
            if (e("#auto_pagination_loader")
                .is(":visible")) {
                e("#auto_pagination_loader")
                    .hide()
            }
            i.stop();
            return
        ...
        if ((n.documentHeight - n.windowScrollY) < n.windowHeight * 3) {
            ...
            i.trigger("before", window.next_page);
            e("#auto_pagination_loader_loading")
                .show();
            e("#auto_pagination_loader_failure")
                .hide();
            f()
        }
    }
    ...
    function a() {
        ...
        n.done(function(p) {
            b(p);
            var o = n.getResponseHeader("X-next-page");
            if (o) {
                window.next_page = o
            } else {
                window.next_page = p.match('id="next_page_link" href="') ? p.split('id="next_page_link" href="')[1].split('"')[0] : false;
                if (!window.next_page) {
                    i.stop()
                }
            }
    ...
    function b(p) {
        if (p.indexOf('<script type="text/javascript" language="javascript" src="//assets.tumblr.com/languages/errors.js') !== -1) {
            i.stop();
            return false
        }
        var o;
        if (p.indexOf("<!-- START POSTS -->") === -1) {
            o = p
        } else {
            o = p.split("<!-- START POSTS -->")[1].split("<!-- END POSTS -->")[0]
        }
        var n = e(e.trim(o))
            .not(":empty");
        e("#posts")
        ...
        setTimeout(function() {
            ...
            c();
            i.trigger("after", window.next_page)
        }, 0)
    }
    ...
    function f() {
        j--;
        var n = window.next_page;
        if (!n.match(/\/dashboard\/(page\/)?\d+/)) {
            return a()
        }
        n = n.replace("/dashboard", "/svc/dashboard");
        var o = e.ajax({
            url: n,
            type: "get"
        });
        o.done(function(p) {
            window.next_page = p.meta.tumblr_old_next_page;
            b(p.response.DashboardPosts.body);
            if (p.response.RecommendedBlog) {
                Tumblr.Events.trigger("component:RecommendedBlog", p.response.RecommendedBlog)
            }
            if (p.response.RapidRecommendations) {
                Tumblr.Events.trigger("component:RapidRecommendations", p.response.RapidRecommendations)
            }
            if (p.response.RemnantAd) {
                Tumblr.Events.trigger("component:RemnantAd", p.response.RemnantAd)
            }
            e("#auto_pagination_loader_loading")
                .hide()
        });
    ...
    d.AutoPaginator = i;
    window.AfterAutoPaginationQueue = m
...
(function(c, b) {
    var a = Backbone.View.extend({
        ...
        events: function() {
            ...
            var e = _(["dragstart", "dragenter", "dragover", "drop", "dragend"])
                .reduce(function(f, g) {
                    f[g + " " + d] = "on_" + g;
                    return f
                }, {});
        ...
        on_dragstart: function(f) {
            ...
            this.placeholder = c(this.dragged)
                .clone()
        ...
        teardown: function() {
            ...
            this.items.add("a, img", this.items)
    ...
    var a = Backbone.View.extend({
        ...
        _add_toast_to_dom: function(d) {
            ...
            if (this.gutterManager) {
                this.gutterManager.putViewInGutter({}, {
                    dimRadar: false
                })
            }
            c("#toast_" + d)
        ...
        _click_helpers: function(d) {
            ...
            if ($anchor.length > 0) {
                $anchor.on("mousedown", function() {
                    c("#toast_" + d)
                        .addClass("toast_active")
                });
                $anchor.on("click, mouseup, mouseleave", function() {
                    c("#toast_" + d)
                        .removeClass("toast_active")
                })
            }
        },
...
(function(c, a) {
    var b = Backbone.Model.extend({
        ...
        like: function(d) {
            ...
            g = this.__(g)
                .replace("%1$s", this._helper_from_tumblelog_link(d));
            var f = {
                message: g,
                is_link: true,
                href: d.target_post_url
        ...
        parse_unread: function(f) {
            ...
            if (e) {
                ...
                if (e > 0) {
                    ...
                    c(".new_post_notice_container")
                        .each(_.bind(function(h, g) {
                            var j = c(g);
                            j.find(".tab_notice_value")
                                .text(d);
...
(function(a) {
    Tumblr.PhotoReply = Backbone.View.extend({
        ...
        show_image: function() {
            ...
            this.$container.css("max-height", this.$image.get(0)
                    .naturalHeight)
                .addClass("has_photo_reply")
        },
        hide_image: function() {
            this.$container.removeClass("has_photo_reply")
                .css("max-height", "")
        },
        enable_dropzone: function() {
            ...
            this.$post.find("*")
                .on("dragenter dragover", this.cancel_event);
            this.$el.find('input[type="file"]')
                .on("click", this._upload_cancel)
                .attr("disabled", false);
        ...
        disable_dropzone: function() {
            ...
            this.$post.find("*")
                .off("dragenter dragover", this.cancel_event);
            this.$el.find('input[type="file"]')
                .off("click", this._upload_cancel)
                .attr("disabled", true)
        },
        create_uploader: function(b) {
            this.destroy_uploader();
            this.$uploader = a(b.form)
                .fileupload({
                    dataType: "json",
                    maxNumberOfFiles: 1,
                    dropZone: b.dropzone,
        ...
        clean_up: function(d) {
            ...
            for (c = 0; c < this.instances.length; c++) {
                b = this.instances[c];
                if (!(b.$el.data("tumblr_photoreply") && b.$el.closest(document.body)
                        .length)) {
                    b.remove();
                    c--
                }
        ...
        scan: function(b) {
            b = a.extend({}, b);
            a(b.el || ".photo_reply_form")
                .each(a.proxy(function(c, d) {
                    if (!a(d)
                        .data("tumblr_photoreply")) {
    ...
    a.prototype = {
        ...
        __any_movement: function() {
            ...
            var e = this.positions[0],
                d = this.positions[this.positions.length - 1];
...
(function(c, a) {
    ...
    d.prototype = {
        ...
        __unbind_events: function() {
            ...
            c(window)
                .off("resize", this.resize);
            c(window)
                .off("keydown", this.keydown);
            c(window)
                .off("keyup", this.keyup);
            c(window)
                .off("blur", this.keycancel)
        },
        __create: function() {
            this.$lightbox = c("<div/>")
                .attr("class", "pano_lightbox")
                .appendTo(c("body"));
            this.$lightbox.css({
                position: "fixed",
                top: 0,
            ...
            c("<img/>")
                .attr("id", "vignette")
                .attr("src", "//assets.tumblr.com/images/full_page_vignette.png")
                .css({
                    position: "absolute",
                    top: 0,
                    left: 0,
        ...
        __open: function() {
            this.__bind_events();
            this.pano.__center_vertically(c(window)
                .height());
    ...
    b.prototype = {
        ...
        __create: function() {
            ...
            this.$container = c("<div/>")
                .attr("class", "pano_container loading");
            this.$view_container = c("<div/>")
                .attr("class", "pano_view_container")
                .appendTo(this.$container);
            this.$viewport = c("<div/>")
                .attr("class", "pano_viewport")
                .appendTo(this.$view_container);
            this.$img_container = c("<div/>")
                .attr("class", "pano_img_container")
                .css({
                    width: this.width,
                    height: this.height,
            ...
            this.$position = c("<div/>")
                ...
                .appendTo(this.$container);
            this.$thumb = c("<img/>")
                .attr("class", "pano_thumb")
                .attr("src", this.$orig_img.attr("src"))
                .appendTo(this.$position);
            this.$shade_left = c("<div/>")
                .attr("class", "pano_shade left")
                .appendTo(this.$position);
            this.$shade_right = c("<div/>")
                .attr("class", "pano_shade right")
                .appendTo(this.$position);
            this.$scrubber = c("<div/>")
                .attr("class", "pano_scrubber grab")
                .appendTo(this.$position);
            this.$dragger = c("<div/>")
                .attr("class", "pano_dragger grab")
                .css({
                    height: this.height
                })
                .appendTo(this.$container);
            this.$scroller = c("<div/>")
                .attr("class", "pano_scroller")
                .css({
                    width: this.width,
                    height: this.height,
        ...
        __load_pano_image: function(e) {
            ...
            this.$img.on("load", this.img_loaded)
                .attr("src", e);
            this.__img_init()
        },
        __img_init: function() {
        ...
        __enforce_max_height: function(f) {
            f = f || 200;
            var g = c(window)
                .height() - this.$position.outerHeight(true);
            g -= 30;
            var e = Math.max(f, Math.min(this.height, g));
            var h = this.width * (e / this.height);
            this.__set_img_dimensions(h, e);
            this.$img_container.css("min-width", c(window)
                .width() - 2 * this.display_side_margins);
            this.__scrubber_sizing()
        },
        ...
        set_inverted_start_position: function(e, f) {
            this.$parent.addClass("grabbing");
            this.start_x = this.$scrubber.position()
                .left;
            this.start_y = this.$scrubber.position()
                .top
        },
...
(function(d, c, b) {
    var a = Tumblr.BaseSearchPopover.extend({
        ...
        getSearchPosition: function() {
            return Tumblr.Flags("dashboard_header_left_search_bar")("header_left", "header_right")
        },
        ...
        set_active: function(g) {
            var e = d(this.popover_selector + " .popover_menu_item a")
                .filter(":visible");
...
(function(c, a) {
    var b = Backbone.View.extend({
        ...
        initialize: function(d) {
            ...
            this.search_loading_template = c("#search_loading_template")
                .html();
            this.search_results_template = c("#search_results_template")
                .html();
            this.search_results_item_blogs_template = c("#search_results_item_blogs")
                .html();
            this.search_results_item_tags_template = c("#search_results_item_tags")
                .html();
            ...
            this.tracked_tags_markup = c("<div>")
                .append(this.$tracked_tags.clone())
                .html()
        },
        ...
        should_add_query_to_tags: function(d) {
            var e = _.find(d, function(g) {
                var i = g.tag.toLowerCase(),
                    j = this.search_query.toLowerCase(),
                    h = this.search_query_raw.toLowerCase();
                return (i == j || i == h)
            }, this);
            if (!e) {
                var f = {
        ...
        update: function() {
            ...
            var f = _.isArray(this.results.tags) ? this.results.tags : [],
                j = _.isArray(this.results.blogs) ? this.results.blogs : [],
                h = "",
                e = false,
                d = false,
            ...
            if (h.length && !this.force_hide) {
                this.$search_results_container.empty()
                    .prop("innerHTML", h);
                this.popover.show()
            } else {
                this.reset_popover()
...
(function(c, b) {
    ...
    a.Base = Backbone.View.extend({
        ...
        initialize: function() {
            ...
            this.tracking_data = {};
            c(window)
                .on("beforeunload.capture", _.bind(this.send_data, this))
        },
        _get_delta: function() {
        ...
        track_context: function() {
            ...
            this.tracking_data.context.language = (window.navigator.userLanguage || window.navigator.language)
                .toLowerCase();
    ...
    a.UserActions = a.Base.extend({
        ...
        track_post_controls: function(g) {
            ...
            if (f.hasClass("reblog_count") || f.closest(".reblog_count")
                .length) {
                e = "notes"
            }
        ...
        track_post_content: function(h) {
            var f = c(h.target),
                d = f.closest(".post"),
                g = this.get_post_id(f),
                i = d.attr("data-type") || "unknown",
                e = f[0].outerHTML.replace(/[\n\r]/g, " ")
                .replace(/\>\s+\/</g, "");
        ...
        track_recommendations: function(h) {
            var f = c(h.target);
            var e = f.closest(".ht_post")
                .data("id"),
                g = (f.hasClass("hello_tag")) ? "tag" : "thumbnail",
                d = f.attr("href");
    ...
    a.HelloDash = a.UserActions.extend({
        ...
        has_zoom_effect: function() {
            return (c('.ht_post[data-effect="grow"]')
                .length || c(".ht_post")
                .data("grow"))
        },
    ...
    a.Radar = a.UserActions.extend({
        ...
        track_radar_controls: function(g) {
            ...
            if (h == "reblog") {
                ...
                c("body")
                    .on("click.capturejs", "#create_post > button, .post-composer_save [data-js-clickablesave]", e)
            } else {
                this["track_" + h](f, g);
                this.track_radar_id()
            }
    ...
    a.WebInStream = a.UserActions.extend({
        ...
        track_sponsored_controls: function(g) {
            var f = (c(g.target)
                .className) ? c(g.target) : c(g.currentTarget);
            ...
            if (f.parent()
                ...
                if (f.parent()
                    .hasClass("post_info") && !f.hasClass("reblog_follow_button") && !f.hasClass("post_header_follow")) {
                    i = "posts"
                } else {
                    if (f.parents(".post_body")
                        .length != 0) {
                        i = "caption"
                    } else {
    ...
    a.SearchPopover = a.UserActions.extend({
        ...
        track_query: function(d) {
            this.tracking_data.query = ((this.get_query_name()
                .length) ? 1 : 0)
        },
        track_tag: function(d) {
            if (d.closest(".result.is_query")
                .length) {
...
(function(f) {
    ...
    e.define("/gif.coffee", function(t, a, l, m) {
        ...
        var q, r, p;
        r = e("events", t)
            .EventEmitter, q = e("/browser.coffee", t), p = function(h, c, i) {
                function g(j) {
                    var b, k;
                ...
                return n(g, h), c = {
                    ...
                    return b.getImageData(0, 0, this.options.width, this.options.height)
                        .data
        ...
        var b = l.EventEmitter = d.EventEmitter,
            n = typeof Array.isArray === "function" ? Array.isArray : function(c) {
...
(function(r, e, s) {
    ...
    function c(t) {
        if (t && typeof t.then === "function") {
            ...
            if (typeof t === "function") {
                ...
                return e.Deferred()[t === false ? "reject" : "resolve"](t)
                    .promise()
            }
        }
    }
    ...
    function d(y, A) {
        ...
        y.detached = r.without.apply(null, [y.detached].concat(w))
            .concat(z);
        y.attached = u
    }
...
(function(b, a) {
    var c = Backbone.View.extend({
        ...
        initialize: function() {
            this.logged_in = (!b(document.body)
                .hasClass("logged_out"));
        ...
        left: function() {
            if (!this.auto_paginate && !b("#tumblr_lightbox")
                .length) {
                var d = b("#previous_page_link")
                    .attr("href");
                if (d) {
                    location.href = d
                }
        ...
        notes: function(f) {
            ...
            if (d.length < 1 || d.find(".note_link_current")
                .text() === "") {
                return
            }
            var g = d.offset()
        ...
        fast_reblog: function(f, g, e) {
            var h = b("#tumblr_form_key")
                .attr("content"),
                d = b("#" + f),
                i = d.find(".post_control.reblog:not(.reblogged)");
            if (i.length && this.check_offset(g) && !i.data("reblogged")) {
                Tumblr.Events.trigger("post:fastreblog", b("#" + f)
                    .data("post-id"), e);
        ...
        blog_switcher: function(h) {
            ...
            if (h.toggle == "stop") {
                this.tab_index = undefined;
                var d = this.tab_current_blog.find("a.blog_name")
                    .attr("href");
                if (!document.location.href.match(d)) {
                    this.tab_current_blog.addClass("loading");
                    var f = new Spinner(Tumblr.spinners.white)
                        .spin();
        ...
        blog_switcher_detection: function() {
            if (window.devicePixelRatio) {
                if (escape(navigator.javaEnabled.toString()) == "function%20javaEnabled%28%29%20%7B%20%5Bnative%20code%5D%20%7D") {
                    b("html")
                        .addClass("tab_switcher_chrome")
                } else {
                    if (escape(navigator.javaEnabled.toString()) != "function%20javaEnabled%28%29%20%7B%20%5Bnative%20code%5D%20%7D") {
                        b("html")
                            .addClass("tab_switcher_safari")
                    }
                }
            }
        },
        ...
        keydown: function(m) {
            ...
            if (g.is("input:focus") || g.is(".result_link:focus") || g.is("[contenteditable=true]")) {
                return
            }
            ...
            var o = (m.shiftKey || m.ctrlKey || m.altKey || m.metaKey),
                l;
                ...
                if (f == 39) {
                    ...
                    if (!o) {
                        ...
                        if (f == 74 && !this.go_to_position) {
                            this.go_to_position = b(document)
                                .height()
                        }
        ...
        keyup: function(g) {
            var f = g.charCode ? g.charCode : g.keyCode,
                d = (g.shiftKey || g.ctrlKey || g.altKey || g.metaKey);
...
(function(b, a) {
    ...
    var c = a.IndashBlog.HeaderCompact.extend({
        ...
        _on_blog_click: function(k) {
            if (b(k.target)
                .closest(".indash_header_wrapper .navigation")
                .length) {
                return
            }
            k.preventDefault();
...
(function(b) {
    var a = Backbone.Model.extend({
        ...
        _createPostTumblelogModel: function(e, d) {
            ...
            var c = false;
            if (d && d.name) {
                c = new Tumblr.Prima.Models.Tumblelog(_(d)
                    .omit(_.isUndefined)
                    .omit(_.isNull)
                    .value())
            }
        ...
        like: function(c) {
            ...
            if (!this.get("liked")) {
                this.set("liked", true);
                Tumblr.like(this.likePayload(c, this.getLikeSource("like")))
                    .error(_.bind(this.trigger, this, "like:failure"))
            }
            this.trigger("like:success", this);
            Tumblr.Events.trigger("post:like:success", this.get("id"), this, c)
        },
        ...
        unlike: function() {
            ...
            Tumblr.unlike(this.likePayload("mouse", this.getLikeSource("unlike")))
                .error(_.bind(this.trigger, this, "unlike:failure"));
        ...
        publish: function() {
            ...
            c.fail(_.bind(function(d) {
                this.trigger("publish:failure", jQuery.parseJSON(d.responseText))
            }, this))
        },
        promote: function(c) {
            var d = b.ajax({
...
(function(c) {
    ...
    Tumblr.PostsView = Backbone.View.extend({
        ...
        createPostModelFromEl: function(d) {
            if (Tumblr.Flags.bool("prima_post_model")) {
                ...
                return new Tumblr.Post({
                    ...
                    reblogged: false,
                    liked: d.find(".post_control.like")
                        .hasClass("liked"),
                    form_key: this.form_key,
                    ...
                    featured_tags: (d.attr("data-featured-tags") || "")
                        .split(","),
        ...
        logExploreTrending: function() {
            ...
            Tumblr.Events.trigger("explore-trending:badge-serve", {
                loggingData: {
...
(function(a) {
    Tumblr.ReplyPopover = Tumblr.PopoverWithForm.extend({
        ...
        initialize: function(b) {
            this.options = b || {};
            var c = _.template(a(this.template)
                .html());
            this.$el.html(c());
            this.submit_button = this.$("button");
            this.textarea = this.$("form textarea");
...
(function(b) {
    ...
    Tumblr.PromoteTagView = Backbone.View.extend({
        ...
        template: function() {
            var c = _.compact(this.$el.data("promotion-warnings")
                .split(";;"));
            var d = "";
            d += "<ul>";
...
(function(d) {
    ...
    Tumblr.PostView = Backbone.View.extend({
        events: {
            ...
            "click .explore-trending-badge": "trending_badge_click",
        ...
        initialize: function() {
            ...
            if (Tumblr.Flags.bool("prima_post_model")) {
                ...
                this.listenTo(Tumblr.Events, "tumblelog:unfollow", function(f) {
                    if (!this.model.get("sponsored") && f.name === this.model.get("tumblelog")) {
                        this.destroy()
                    }
                })
            } else {
        ...
        _post_action_follow: function(h, f) {
            ...
            this.$el.find(".follow")
                .addClass("follow_poof")
        },
        _on_tumblelog_popover_follow: function(f) {
            if (this.model.tumblelog && this.model.tumblelog.get("name") === f) {
        ...
        ask_answer: function(l) {
            l.preventDefault();
            var j = window.tinyMCE || false;
            var m = d(l.currentTarget);
            var n = m.closest(".post");
            var g = n.find(".post_ask_answer_form");
            var q = n.find(".post_ask_answer_field");
            var o = q.attr("id");
            g.show();
            n.find(".post_footer")
                .hide();
            ...
            if (c.bool("prima_post_forms")) {
                ...
                if (!this.richTextEditor) {
                    ...
                    this.richTextEditor = new Tumblr.Prima.RichTextEditorView({
                        placeholder: b.write_a_response || "Your answer here",
                        className: "ask-answer-field",
                        supportInlineEmbeds: false,
                        model: p,
                        name: "answer"
                    });
                    this.listenTo(p, "change:answer", function(r, s) {
                        s = s.replace(/src=\"data:[^\"]*\">/gi, "");
                        q.val(s)
                    });
                    q.after(this.richTextEditor.render()
                            .$el)
                        .hide()
                }
                d(this.richTextEditor.editor.element)
                    .focus(f)
                    .blur(h);
                ...
                if (j) {
                    if (j.get(o)) {
                        j.execInstanceCommand(o, "mceFocus")
                    } else {
                        Tumblr.Editor.render(o, {
                            skin: "bluth",
                        ...
                        var k = d("#regular_image_upload");
                        var i = new Tumblr.PostForms.RegularModel();
                        i.init_uploader(k);
                        i.on("change:upload_complete", function(t) {
                            var s = j.get(o);
                            var u = t.response[0].url;
                            var r = new Image();
                            d(r)
                                .one("load", _.bind(function(v) {
                                    d(r)
                                        .off();
                                    s.execCommand("mceInsertContent", false, '<img src="' + u + '" />');
                                    s.execCommand("mceInsertContent", false, "<p>");
                                    setTimeout(function() {
                                        s.execCommand("mceAutoResize")
                                    }, 100)
                                }, this))
                                .one("error", function(v) {
                                    d(r)
                                        .off()
                                });
                            r.src = u
                    ...
                    j.onAddEditor.add(function(s, r) {
                        r.onKeyDown.add(function(t, u) {
                            if (u.keyCode === 18) {
        ...
        ignore: function(h) {
            ...
            if (_.has(this.model.get("tumblelog_data"), "avatar_url")) {
                g = this.model.get("tumblelog_data")
                    .avatar_url
            } else {
                if (this.$(".post_avatar_link")
                    .attr("data-avatar-url")) {
                    g = this.$(".post_avatar_link")
                        .attr("data-avatar-url")
                }
            }
            var m = {
        ...
        updateLikeStatus: function() {
            ...
            var f = d('<div class="post_animated_heart post_poof"><span class="heart_left"></span><span class="heart_right"></span></div>')
                .toggleClass("unliked", !g);
            if (this.is_click_trigger) {
        ...
        failure: function(f) {
            if (f.response[0] !== "") {
                Tumblr.Dialog.alert(f.response[0])
            } else {
        ...
        setupAnswerForm: function() {
            ...
            if (!(this.answer_form instanceof Tumblr.AnswerForm) && f.find(".post_answer_input")
                .length) {
        ...
        photo_reply_click: function(f) {
            e.init([{
                high_res: d(f.currentTarget)
                    .find("img")
                    .attr("src"),
                low_res: d(f.currentTarget)
                    .find("img")
                    .attr("src"),
                width: 500
            }])
        ...
        share_click: function() {
            a.trigger("useraction:click:post_share", {
                model: this.model,
                loggingData: this.loggingData({
                    userAction: "share"
                })
        ...
        trending_badge_click: function() {
            Tumblr.Events.trigger("explore-trending:badge-click", {
                loggingData: {
        ...
        content_link_click: function(h) {
            ...
            if (window.self !== top && g.is(".post_control.reblog, .post_control.edit")) {
                ...
                if (g.closest(".no_pop, .post_controls, #new_post, .controls, .user_menu_list, form, .flash_notification, .more_notes_link")
                    .length > 0) {
                    return
                }
                if (!f || f === "#") {
    ...
    var a = Tumblr.PostView.extend({
        ...
        "$permalink": function() {
            if (!this._$permalink && this.$post) {
                this._$permalink = this.$post.closest(".post_full")
                    .find(".post_permalink")
            }
        ...
        render: function() {
            ...
            e.blog_name = d.text();
            e.permalink = this.$post.find(".post_avatar_link")
                .data("blog-url");
            ...
            if (h.length) {
                h = h.clone();
                b(".follow_button_wrapper", h)
                    .remove();
                this.$header.append(h);
                h.find(".popover_sponsored")
                    .remove()
            }
            ...
            this.$footer = this.$post.find(".post_footer")
                .clone();
            this.$footer.find(".post_notes .popover")
                .removeClass("nipple_on_left")
                .addClass("nipple_on_right");
            this.$footer.find(".post_control")
                .each(_.bind(function(m, l) {
                    var k = b(l),
                        j;
...
(function(b) {
    var a = Backbone.View.extend({
        ...
        setupHarness: function() {
            ...
            this.$embed(true);
            var c = this.embedManager.getHarness(this.$embed()
                .attr("id"));
        ...
        _bindCrtPlayerEvents: function() {
            if (this.harness._data.service === "tumblr" && this.harness.player) {
                var c = this.harness.player;
                this.listenTo(c.player, "pause", _.bind(function() {
                    if (!c.get("autoplay")) {
                        this.autoDockOnScroll = true
                    }
                }, this));
                this.listenTo(c.player, "muteClicked", _.bind(function() {
                    if (!c.get("autoplay")) {
                        this.autoDockOnScroll = false
                    }
                }, this));
                this.listenTo(c.player, "looped", _.bind(function() {
                    if (!c.get("autoplay")) {
                        this.autoDockOnScroll = false
                    }
                }, this))
        ...
        onExitViewport: function() {
            if (this.autoDockOnScroll) {
                ...
                if (!this.isInGutter() && this.videoState === "playing" && !d) {
                    var c = _.clone(this.gutterViewOptions);
                    c.animation = "slide";
        ...
        onStateChange: function(c) {
            ...
            this.videoState = c;
            if (!this.harness.player && !this.isInGutter() && this.videoState === "playing") {
                this.autoDockOnScroll = true
            }
        },
        "$post": function() {
        ...
        moveToGutter: function(d) {
            ...
            c.height = this.embedDimensionsForWidth(c.width)
                .height;
            ...
            if (this.canResize) {
                this.$embed()
                    .velocity(_.pick(c, "width", "height"));
                if (d.animation === "fall") {
                    this.$el.velocity(c, {
        ...
        removeFromGutter: function() {
            var c = this.$placeholder.get(0)
                .getBoundingClientRect();
            if ((-c.top > c.height) || (c.top > window.innerHeight)) {
        ...
        originalEmbedLocation: function() {
            ...
            return {
                left: "50%",
                width: d.width,
                height: this.embedDimensionsForWidth(d.width)
                    .height,
        ...
        fixElInOriginalPlace: function(d) {
            ...
            this.$embed()
                .velocity(_.pick(c, "width", "height"), _.pick(d, "duration"))
        },
...
(function(c) {
    ...
    Tumblr.Notes = Backbone.View.extend({
        ...
        initialize: function() {
            ...
            this.popover = new e({
                ...
                on_load_more: function() {
                    if (!g.loading_notes && this.$el.find("a.more_notes_link")
                        .length > 0) {
        ...
        create_note_views: function(g) {
            g.find(".note:not([data-view-exists])")
                .each(function(j, k) {
                    var h;
                    if (c(k)
                        .hasClass("reblog")) {
        ...
        on_more_click: function(g) {
            g.preventDefault();
            this.more_notes(c(g.currentTarget)
                .closest(".post"))
        },
        ...
        on_notes_show: function(i) {
            var h = c(i),
                g = h.closest(".post");
            this.at_end = (h.find(".more_notes_link")
                .data("notes-complete")) ? true : false;
        ...
        more_notes: function(i) {
            var g = c(i);
            var h = g.find(".more_notes_link")
                .hide();
            var j = g.find(".notes_loading")
                .show();
            this.loading_notes = true;
            this.load_notes(g, {
                from_id: h.attr("data-next")
        ...
        load_notes: function(g, j, m) {
            ...
            c.ajax(h)
                .done(_.bind(function(t, u, r) {
                    var q = g.find(".more_notes_link_container"),
                        o = g.find(".notes"),
                        p = g.find(".more_notes_link"),
                        s = g.find(".notes_loading");
                    p.show();
                    s.hide();
                    t = c.trim(t);
    ...
    Tumblr.DraggableTags = Backbone.View.extend({
        ...
        dragStart: function(b) {
            ...
            if (!this.dragging && !this.pointer_down) {
                ...
                this.start_x = this.drag_inner.position()
                    .left;
...
(function(c) {
    ...
    var a = Tumblr.IndashBlog.HeaderCompact.extend({
        ...
        render: function() {
            ...
            this.$(".header_image_wrapper, .header_image")
                .height(e * this.options.aspect_ratio);
    ...
    a.attach_to_el = function(g) {
        ...
        for (var h = 0; h < l.length; h++) {
            var e = new k({
                ...
                .render();
            c.merge(f, c('<div class="blog-card-container"></div>')
                .append(e.$el))
        }
        f.appendTo(j)
    };
...
(function(f, a) {
    ...
    var e = Backbone.View.extend({
        ...
        add_footer: function() {
            var g = _.template(f("#follow_list_" + this.data.context + "_small_links_template")
                .html(), {
    ...
    var b = Backbone.View.extend({
        ...
        render: function() {
            ...
            var h = _.template(f("#follow_list_item_template")
                .html(), g);
            this.$el.html(h);
...
jQuery(document)
    .ready(function(b) {
        if (!Tumblr.Flags.bool("prima_recommended_blogs_list") || b("#tagged_actions_display")
            .hasClass("is_featured_tag")) {
            var a = b.trim(b("#follow_list_template")
                .html());
            b(".follow_list")
                .each(function(d, c) {
    ...
    var d = {
        updatePostInline: function(j) {
            ...
            if (l.length) {
                ...
                n.find(".post_controls_inner")
                    .append(h.find(".post_control.reblog"))
            }
            h.after(o);
            n.find("iframe.spotify_player")
                .css("opacity", 0)
                .addClass("iframe_reload_and_fade_in");
        ...
        afterHide: function(j) {
            ...
            if (!j.post.is_edit && (f("#new_post")
                    .length > 0) && h && !j.post.is_reblog && !j.fastCompose) {
        ...
        displayNotification: function(h, j) {
            ...
            var i = k[1] || "";
            var l = (i.toLowerCase() === "blog" ? k[2] : f('input[name="t"]')
                .val()) || "";
...
(function(e, b, a) {
    ...
    a[e] = {
        ...
        settings: {
            ...
            useFlash: (function() {
                ...
                return !(f.canPlayType && f.canPlayType("audio/mpeg;")
                    .replace(/no/, ""))
            })(),
            hasFlash: (function() {
            ...
            flashError: function() {
                var h = this.settings.createPlayer,
                    f = c(h.errorMessageClass, this.wrapper),
                    g = 'Missing <a href="http://get.adobe.com/flashplayer/">flash player</a> plugin.';
                if (this.mp3) {
            ...
            loadError: function(h) {
                var g = this.settings.createPlayer,
                    f = c(g.errorMessageClass, this.wrapper);
            ...
            loadStarted: function() {
                var g = this.settings.createPlayer,
                    i = c(g.durationClass, this.wrapper),
            ...
            loadProgress: function(h) {
                var g = this.settings.createPlayer,
                    i = c(g.scrubberClass, this.wrapper),
                    f = c(g.loaderClass, this.wrapper);
            ...
            updatePlayhead: function(j) {
                var h = this.settings.createPlayer,
                    l = c(h.scrubberClass, this.wrapper),
                    g = c(h.progressClass, this.wrapper);
                g.style.width = (l.offsetWidth * j) + "px";
                var k = c(h.playedClass, this.wrapper),
                    n = this.duration * j,
                    f = Math.floor(n / 60),
                    i = Math.floor(n % 60);
        ...
        createAll: function(g, k) {
            var f = k || document.getElementsByTagName("audio"),
                l = [];
            g = g || {};
        ...
        newInstance: function(g, f) {
            var g = g,
                h = this.helpers.clone(this.settings),
                l = "audiojs" + this.instanceCount,
                k = "audiojs_wrapper" + this.instanceCount,
                j = this.instanceCount++;
        ...
        createPlayer: function(g, f, j) {
            ...
            i.setAttribute("id", j);
            if (h.outerHTML && !document.createElement("audio")
                .canPlayType) {
        ...
        attachEvents: function(k, h) {
            ...
            var g = h.settings.createPlayer,
                j = c(g.playPauseClass, k),
                i = c(g.scrubberClass, k),
                f = function(l) {
                    var m = 0;
                    if (l.offsetParent) {
                        do {
        ...
        helpers: {
            ...
            injectCss: function(g, k) {
                var q = "",
                    p = document.getElementsByTagName("style"),
                    j = k.replace(/\$1/g, g.settings.imageLocation);
            ...
            ready: (function() {
                return function(l) {
                    var h = window,
                        ...
                        n = h.document,
                        m = n.documentElement,
                        q = n.addEventListener ? "addEventListener" : "attachEvent",
                        o = n.addEventListener ? "removeEventListener" : "detachEvent",
                        f = n.addEventListener ? "" : "on",
                        p = function(r) {
    ...
    var c = function(n, j) {
        ...
        if (j.getElementsByClassName) {
            ...
            var h, f, g = j.getElementsByTagName("*"),
                k = new RegExp("(^|\\s)" + n + "(\\s|$)");
...
(function(c, e, b) {
    ...
    a.prototype = {
        ...
        __get_post_data: function() {
            return this.postData || (this.postData = this.__get_post()
                .data("json"))
        },
        __cache_selectors: function() {
            ...
            this.$album_art = this.$container.find(".album_art")
                .not(this.$main_album_art)
                .hide()
        },
        ...
        on_seek_mousemove: function(h) {
            var g = this.get_seek_progress(h.pageX - this.$progress_container.offset()
                .left);
        ...
        on_seek_end: function(g) {
            ...
            this.skip_to(Math.min(this.total_time ? (this.total_time - 0.1) / this.total_time : 1, this.get_seek_progress(g.pageX - this.$progress_container.offset()
                .left)));
            if (this.was_playing) {
                this.play()
            }
        ...
        load_track: function(h) {
            ...
            this.$album_art.not(this.$current_album_art)
                .hide();
            this.truncate_text();
        ...
        generate_equalizer: function() {
            ...
            this.$equalizer = e("<div/>")
                .addClass("audio_equalizer");
        ...
        equalizer_levels: function(j, k, h, g) {
            ...
            if (typeof j !== "number" && !e.isArray(j)) {
                var i = [];
                this.$equalizer.children(".audio_equalizer_band")
                    .each(function(l, m) {
                        i[l] = e(m)
                            .data("level")
                    });
        ...
        reset_animation: function() {
            ...
            e(document.body)
                .trigger("tumblr:audio:animation_complete", {
                    audioplayer: this
                });
        ...
        generate_demo_eq: function(j, i, g, h) {
            ...
            return c.range(this.config.eq.bands)
                .map(e.proxy(function(k, l) {
    ...
    a.__init_jukebox = function(g) {
        ...
        e(document.body)
            .on("click.tumblraudio", ".audio_player_container.placeholder", function(j) {
        ...
        if (b.DOMEventor) {
            ...
            e(window)
                .on("scroll", c.debounce((function(i) {
                    var k = e(window);
    ...
    a.replace_placeholders = function(g, h) {
        ...
        i.find(".audio_player_container.placeholder")
            .each(c.bind(function(j, k) {
    ...
    a.clean_up = function(j) {
        ...
        for (h = 0; h < this.instances.length; h++) {
            g = this.instances[h];
            if (!g.$container.closest(document.body)
                .length) {
                this.unregister(g);
                h--
            }
    ...
    a.sort = function() {
        e.each(e(".audio_player_container"), function(h, g) {
            e(g)
                .data("tumblr_audioplayer_sort", h)
        });
    ...
    var f = (function() {
        var k = new RegExp("audio(\\.min|_src|_player)?\\.js.*"),
            l = new RegExp("(^[^/]+//[^/]+|)(/.*$)|(.*)"),
    ...
    a.defaults = {
        ...
        audiojs_settings: {
            ...
            flashError: function() {
                ...
                g.flash_error = true;
                g.error = true;
                g.$player.addClass("inactive error flash_error")
                    .removeClass("playing");
            ...
            loadError: function() {
                ...
                var g = this.audioplayer;
                g.error = true;
                g.$player.addClass("inactive error")
                    .removeClass("playing");
            ...
            flashReady: function() {
                ...
                g.bind_events();
                e(document.body)
                    .trigger("tumblr:audio:flashready", {
                        audioplayer: g
                    })
            },
            play: function() {
...
(function(d, a) {
    ...
    var e = {
        initialize: function() {
            d(document)
                .on("click", "a.ask", _.bind(function(g) {
                    g.preventDefault();
    ...
    var b = Backbone.View.extend({
        ...
        initialize: function(g) {
            this.options = g || {};
            this.template = d("#dashboard_ask_template")
                .html() || d("#dashboard_ask_template", window.parent.document)
                .html();
            this.$body = d("body");
        ...
        show_form: function() {
            ...
            d(document)
                .on("keydown", this.keyboard_events.keydown);
        ...
        destroy: function() {
            this.remove();
            d(document)
                .off("keydown", this.keyboard_events.keydown)
        },
        update: function() {
            if (d.trim(this.$question.val())
                .length > 0) {
                this.enable_submit()
            } else {
                this.disable_submit()
            ...
            if (this.$question.val()
                .match(/\n/g)) {
                this.$question.val(this.$question.val()
                    .replace(/\n/g, ""))
            }
            if (this.$question.val()
                .length > this.ask_limit) {
                this.$question.val(this.$question.val()
                    .substring(0, this.ask_limit))
            }
            var g = this.ask_limit - this.$question.val()
                .length;
                ...
                success: _.bind(function(h) {
                    setTimeout(_.bind(function() {
                        ...
                        if (typeof Tumblr.Toaster === "object" && typeof Tumblr.ToastKit === "object") {
                            ...
                            j = Tumblr.ToastKit.__(j)
                                .replace("%1$s", this.recipient);
                            var i = {
                                type: "image_text",
...
(function(b) {
    ...
    ap = function() {
            ...
            var j, i;
            a = (n === !1 ? parseFloat(a)
                    .toString() : a.toFixed(n))
                .split(""), j = (j = ar.inArray(".", a)) < 0 ? a.length : j, j < a.length && (a[j] = k);
            for (i = j - m; i > 0; i -= m) {
                a.splice(i, 0, l)
            }
            return a.join("")
            ...
            var c;
            document.createStyleSheet ? document.createStyleSheet()
                .cssText = d : (c = document.createElement("style"), c.type = "text/css", document.getElementsByTagName("head")[0].appendChild(c), c[typeof document.body.style.WebkitAppearance == "string" ? "innerText" : "innerHTML"] = d)
        }, ar.fn.simpledraw = function(a, l, k, j) {
            var i, h;
            if (k && (i = this.data("_jqs_vcanvas"))) {
                return i
            }
            a === undefined && (a = ar(this)
                .innerWidth()), l === undefined && (l = ar(this)
                .innerHeight());
            ...
            return h = ar(this)
                .data("_jqs_mhandler"), h && h.registerCanvas(i), i
            ...
            mouseenter: function(a) {
                ar(document.body)
                    .unbind("mousemove.jqs"), ar(document.body)
                    .bind("mousemove.jqs", ar.proxy(this.mousemove, this)), this.over = !0, this.currentPageX = a.pageX, this.currentPageY = a.pageY, this.currentEl = a.target, !this.tooltip && this.displayTooltips && (this.tooltip = new W(this.options), this.tooltip.updatePosition(a.pageX, a.pageY)), this.updateDisplay()
            },
            mouseleave: function() {
                ar(document.body)
            ...
            init: function(a) {
                var h = a.get("tooltipClassname", "jqstooltip"),
                    g = this.sizeStyle,
                    f;
                this.container = a.get("tooltipContainer") || document.body, this.tooltipOffsetX = a.get("tooltipOffsetX", 10), this.tooltipOffsetY = a.get("tooltipOffsetY", 12), ar("#jqssizetip")
                    .remove(), ar("#jqstooltip")
                    .remove(), this.sizetip = ar("<div/>", {
                        id: "jqssizetip",
                        style: g,
                        "class": h
                    }), this.tooltip = ar("<div/>", {
                    ...
                    .appendTo(this.container), f = this.tooltip.offset(), this.offsetLeft = f.left, this.offsetTop = f.top, this.hidden = !0, ar(window)
                    .unbind("resize.jqs scroll.jqs"), ar(window)
                    .bind("resize.jqs scroll.jqs", ar.proxy(this.updateWindowDims, this)), this.updateWindowDims()
            },
            updateWindowDims: function() {
                this.scrollTop = ar(window)
                    .scrollTop(), this.scrollLeft = ar(window)
                    .scrollLeft(), this.scrollRight = this.scrollLeft + ar(window)
                    .width(), this.updatePosition()
            },
            getSize: function(b) {
                this.sizetip.html(b)
                    .appendTo(this.container), this.width = this.sizetip.width() + 1, this.height = this.sizetip.height(), this.sizetip.remove()
            },
            setContent: function(b) {
                ...
                this.getSize(b), this.tooltip.html(b)
                    .css({
                        width: this.width,
                        height: this.height,
                        visibility: "visible"
            ...
            remove: function() {
                this.tooltip.remove(), this.sizetip.remove(), this.sizetip = this.tooltip = undefined, ar(window)
            ...
            return this.each(function() {
                ...
                c = function() {
                    ...
                    if (i.get("height") === "auto") {
                        if (!i.get("composite") || !ar.data(this, "_jqs_vcanvas")) {
                            n = document.createElement("span"), n.innerHTML = "a", h.html(n), o = ar(n)
                                .innerHeight() || ar(n)
                                .height(), ar(n)
                                .remove(), n = null
                        }
                ...
                if (ar(this)
                    .html() && !i.get("disableHiddenCheck") && ar(this)
                    .is(":hidden") || ar.fn.jquery < "1.3.0" && ar(this)
                    .parents()
                    .is(":hidden") || !ar(this)
                    .parents("body")
                    .length) {
            ...
            for (h = 0, g = N.length; h < g; h++) {
                a = N[h][0], ar(a)
                    .is(":visible") && !ar(a)
                    .parents()
                    .is(":hidden") ? (N[h][1].call(a), ar.data(N[h][0], "_jqs_pending", !1), f.push(h)) : !ar(a)
                    .closest("html")
                    .length && !ar.data(a, "_jqs_pending") && (ar.data(N[h][0], "_jqs_pending", !1), f.push(h))
            }
            for (h = f.length; h; h--) {
                N.splice(f[h - 1], 1)
            }
            ...
            drawNormalRange: function(r, q, p, o, n) {
                ...
                this.target.drawRect(r, k, o, j, undefined, this.options.get("normalRangeColor"))
                    .append()
            },
            render: function() {
                var aV = this.options,
                ...
                aD = aF.length;
                for (u = 0; u < aD; u++) {
                    aU.drawShape(aF[u], aV.get("fillColor"), aV.get("fillColor"))
                        .append()
                }
                aV.get("normalRangeMin") !== undefined && aV.get("drawNormalOnTop") && this.drawNormalRange(aK, aL, aS, aT, aN), aD = aG.length;
                for (u = 0; u < aD; u++) {
                    aU.drawShape(aG[u], aV.get("lineColor"), undefined, aV.get("lineWidth"))
                        .append()
                }
                if (aQ && aV.get("valueSpots")) {
                    aB = aV.get("valueSpots"), aB.get === undefined && (aB = new aa(aB));
                    for (u = 0; u < a; u++) {
                        ay = aB.get(au[u]), ay && aU.drawCircle(aK + Math.round((aw[u] - this.minx) * (aT / aO)), aL + Math.round(aS - aS * ((au[u] - this.miny) / aN)), aQ, undefined, ay)
                            .append()
                    }
                }
                aQ && aV.get("spotColor") && au[aM] !== null && aU.drawCircle(aK + Math.round((aw[aw.length - 1] - this.minx) * (aT / aO)), aL + Math.round(aS - aS * ((au[aM] - this.miny) / aN)), aQ, undefined, aV.get("spotColor"))
                    .append(), this.maxy !== this.minyorg && (aQ && aV.get("minSpotColor") && (aE = aw[ar.inArray(this.minyorg, au)], aU.drawCircle(aK + Math.round((aE - this.minx) * (aT / aO)), aL + Math.round(aS - aS * ((this.minyorg - this.miny) / aN)), aQ, undefined, aV.get("minSpotColor"))
                        .append()), aQ && aV.get("maxSpotColor") && (aE = aw[ar.inArray(this.maxyorg, au)], aU.drawCircle(aK + Math.round((aE - this.minx) * (aT / aO)), aL + Math.round(aS - aS * ((this.maxyorg - this.miny) / aN)), aQ, undefined, aV.get("maxSpotColor"))
                        .append())), this.lastShapeId = aU.getLastShapeId(), this.canvasTop = aL, aU.render()
            }
            ...
            render: function() {
                ...
                for (h = 2; h < f; h++) {
                    g = this.renderRange(h)
                        .append(), this.shapes[g.id] = "r" + h, this.valueShapes["r" + h] = g.id
                }
                this.values[1] !== null && (g = this.renderPerformance()
                    .append(), this.shapes[g.id] = "p1", this.valueShapes.p1 = g.id), this.values[0] !== null && (g = this.renderTarget()
                    .append(), this.shapes[g.id] = "t0", this.valueShapes.t0 = g.id), e.render()
            }
            ...
            getCurrentRegionFields: function() {
                ...
                return {
                    ...
                    color: this.options.get("sliceColors")[b % this.options.get("sliceColors")
                        .length],
                    offset: b
                }
            },
            ...
            renderSlice: function(F, E) {
                ...
                for (s = 0; s < r; s++) {
                    ...
                    if (F === s) {
                        return q = C.get("sliceColors")[s % C.get("sliceColors")
                            .length], E && (q = this.calcHighlightColor(q, C)), D.drawPieSlice(B, B, B - A, u, t, undefined, q)
                    }
                    v = t
                }
            },
            render: function() {
                ...
                l && i.drawCircle(m, m, Math.floor(m - l / 2), n.get("borderColor"), undefined, l)
                    .append();
                for (j = h.length; j--;) {
                    h[j] && (k = this.renderSlice(j)
                        .append(), this.valueShapes[j] = k.id, this.shapes[k.id] = j)
                }
                i.render()
            }
            ...
            render: function() {
                ...
                this.quartiles = [B, A, z], this.lwhisker = E, this.rwhisker = y, this.loutlier = D, this.routlier = x, g = at / (G - H + 1), au.get("showOutliers") && (F = Math.ceil(au.get("spotRadius")), at -= 2 * Math.ceil(au.get("spotRadius")), g = at / (G - H + 1), D < E && ax.drawCircle((D - H) * g + F, I / 2, au.get("spotRadius"), au.get("outlierLineColor"), au.get("outlierFillColor"))
                        .append(), x > y && ax.drawCircle((x - H) * g + F, I / 2, au.get("spotRadius"), au.get("outlierLineColor"), au.get("outlierFillColor"))
                        .append()), ax.drawRect(Math.round((B - H) * g + F), Math.round(I * 0.1), Math.round((z - B) * g), Math.round(I * 0.8), au.get("boxLineColor"), au.get("boxFillColor"))
                    .append(), ax.drawLine(Math.round((E - H) * g + F), Math.round(I / 2), Math.round((B - H) * g + F), Math.round(I / 2), au.get("lineColor"))
                    .append(), ax.drawLine(Math.round((E - H) * g + F), Math.round(I / 4), Math.round((E - H) * g + F), Math.round(I - I / 4), au.get("whiskerColor"))
                    .append(), ax.drawLine(Math.round((y - H) * g + F), Math.round(I / 2), Math.round((z - H) * g + F), Math.round(I / 2), au.get("lineColor"))
                    .append(), ax.drawLine(Math.round((y - H) * g + F), Math.round(I / 4), Math.round((y - H) * g + F), Math.round(I - I / 4), au.get("whiskerColor"))
                    .append(), ax.drawLine(Math.round((A - H) * g + F), Math.round(I * 0.1), Math.round((A - H) * g + F), Math.round(I * 0.9), au.get("medianColor"))
                    .append(), au.get("target") && (v = Math.ceil(au.get("spotRadius")), ax.drawLine(Math.round((au.get("target") - H) * g + F), Math.round(I / 2 - v), Math.round((au.get("target") - H) * g + F), Math.round(I / 2 + v), au.get("targetColor"))
                        .append(), ax.drawLine(Math.round((au.get("target") - H) * g + F - v), Math.round(I / 2), Math.round((au.get("target") - H) * g + F + v), Math.round(I / 2), au.get("targetColor"))
                        .append()), ax.render()
            }
        }),
        function() {
            ...
            _calculatePixelDims: function(a, h, g) {
                var f;
                f = this._pxregex.exec(h), f ? this.pixelHeight = f[1] : this.pixelHeight = ar(g)
                    .height(), f = this._pxregex.exec(a), f ? this.pixelWidth = f[1] : this.pixelWidth = ar(g)
                    .width()
            },
            ...
            init: function(a, h, g, f) {
                R._super.init.call(this, a, h, g), this.canvas = document.createElement("canvas"), g[0] && (g = g[0]), ar.data(g, "_jqs_vcanvas", this), ar(this.canvas)
                    .css({
                        display: "inline-block",
                        width: a,
                        height: h,
                        verticalAlign: "top"
                    }), this._insert(this.canvas, g), this._calculatePixelDims(a, h, this.canvas), this.canvas.width = this.pixelWidth, this.canvas.height = this.pixelHeight, this.interact = f, this.shapes = {}, this.shapeseq = [], this.currentTargetShapeId = undefined, ar(this.canvas)
                    .css({
            ...
            init: function(a, h, g) {
                var f;
                P._super.init.call(this, a, h, g), g[0] && (g = g[0]), ar.data(g, "_jqs_vcanvas", this), this.canvas = document.createElement("span"), ar(this.canvas)
                    .css({
                        display: "inline-block",
                        position: "relative",
                        overflow: "hidden",
    ...
    var c = Backbone.View.extend({
        ...
        update_slide: function(f, d) {
            ...
            if (this.display_like_and_reblog) {
                ...
                if (d.like_url === "#like") {
                    g.off("click.NerdSlideshow")
                        .on("click.NerdSlideshow", function(j) {
                            j.preventDefault();
                            ...
                            Tumblr[k]({
                                ...
                                complete: function() {
                                    b("#rad_slideshow_like_" + d.post_id)
                                        .toggleClass("red");
        ...
        transition: function() {
            b(this.current_slide)
                .fadeOut(_.bind(function(f) {
                    if (this.next_slide) {
                        this.next_slide.css({
                            zIndex: 1
                        })
...
(function(d, e, b) {
    ...
    var a = e.View.extend({
        ...
        initialize: function() {
            ...
            this.form_key = d("#tumblr_form_key")
                .attr("content");
            ...
            if (this.version === "v2" && this.$el.hasClass("radar_type_video")) {
                ...
                if (this.version === "v2" && this.$el.find(".photoset")
                    .length > 0) {
        ...
        renderFollow: function(f, g) {
            ...
            this.$(".radar_footer")
                .toggleClass("has_follow_button", !g)
        },
        ...
        update_note_count: function(g) {
            var f = this.$el.find(".note_link_current"),
                h;
            if (g) {
                h = f.data("more");
        ...
        run_click: function(h) {
            ...
            if (Tumblr.TumblelogDrawer && Tumblr.Prima.Url.isTumblelogUrl(f)) {
                return
            } else {
                if (Tumblr.Prima.Url.hasAllowedProtocol(f)) {
                    window.open(f)
...
(function(c, a) {
    ...
    a.ImpressionTracking = {
        ...
        track: function() {
            ...
            var e = Tumblr.Prima.DOMEventor.lastRect()
                .windowScrollTop;
            var d = ((e || 0) <= h);
        ...
        check_for_ads: function() {
            ...
            this.register(".follow_list_item_blog.pt");
            this.register(".tumblr-dot.pt");
            this.track()
        },
        log_impression: function(d) {
            ...
            var j = d.data("placementId");
            var i = d.hasClass("radar");
            var f = d.data("pt");
            var h = false;
            if ((/^mb_[0-9]{1,20}$/)
                .test(j)) {
            ...
            this.fire_tracking_pixels(d)
        },
        _send_beacon: function(d) {
            var e = document.createElement("img");
            e.src = d
        },
        fire_tracking_pixels: function(d) {
            var e = d.data("root-id")
        }
    }
})(jQuery, Tumblr || {});
jQuery(document)
