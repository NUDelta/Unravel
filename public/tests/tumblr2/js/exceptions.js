...
(function(s, J) {
    ...
    function h(O) {
        var P = decodeURIComponent(f.cookie)
            .match(new RegExp(O + "=([^;]+)"));
    ...
    function m(S, P, R, O, Q) {
        try {
            ...
            q.push({
                path: (f.location || {})
                    .pathname || "NO_LOCATION_OR_PATHNAME",
                msg: g(S, 200) || "",
                url: P,
                ln: i(R, 10) || -1,
                col: i(O, 10) || -1,
    ...
    var w = l.debugDump = function() {
        ...
        return {
            ...
            ephemeral: I,
            errors: q,
            document: (f.documentElement || {})
                .innerHTML || "NO_DOCUMENT"
        }
    };
    ...
    function e(T) {
        ...
        d(P, function(W) {
            ...
            var X = V.split(".")[0];
            U[W.initiatorType].push({
                name: W.name.split(V)[1],
                duration: W.duration,
                bucket: X
            })
        });
    ...
    function L() {
        try {
            ...
            t("js_debugger_1")(function() {
                (O || (O = {}))
                .ephemeral = [r("js_debugger_1")]
            });
            t("js_debugger_2")(function() {
                (O || (O = {}))
                .ephemeral = [r("js_debugger_2")]
            });
            if (!O) {
                return
            }
            var Q = JSON.stringify({
                form_key: (f.getElementById("tumblr_form_key") || f.body)
                    .getAttribute("content"),
                gpop: (f.getElementById("tumblr_gpop") || f.body)
                    .getAttribute("content"),
                log: O
            });
            var R = new G();
            ...
            s.jQuery.ajax({
                ...
                type: "POST",
                data: {
                    form_key: s.jQuery("#tumblr_form_key")
                        .attr("content"),
                    log: O
                },
